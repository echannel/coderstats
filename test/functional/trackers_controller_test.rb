...
class TrackersControllerTest < ActionController::TestCase
  ...
  test "should create tracker" do
    assert_difference('Tracker.count') do
      post :create, tracker: { code: @tracker.code, name: @tracker.name, points: @tracker.points }
    end
  ...
  test "should update tracker" do
    put :update, id: @tracker, tracker: { code: @tracker.code, name: @tracker.name, points: @tracker.points }
    assert_redirected_to tracker_path(assigns(:tracker))
  end
